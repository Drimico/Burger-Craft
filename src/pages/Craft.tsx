...
const Craft = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="-z-1 w-screen h-full bg-[url(/images/craft-background.png)] bg-cover bg-center">
        <div className="font-bold pointer-events-none lg:text-8xl md:text-7xl sm:text-6xl 400:text-4xl 300:text-3xl text-2xl text-sky-600 flex justify-around  items-center h-screen z-10 relative">
          <div className="bg-black/10 backdrop-blur-sm border border-white/10 shadow-2xl rounded-full px-10 py-5">{t("ui.craft_title")}</div>
        </div>
        <Element name="bottom" />
      </div>
